...
int main()
{
	...
	// destruction time.
	{
		...
		// DONE:  Create a vector of Student pointers, and set each pointer
		...
		// DONE:  Using the now-sorted vector of pointers, replace each Student
